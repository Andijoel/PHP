...
<table class="table table-bordered w-70">
      ...
      <tbody>
	      ...
	      <tr>
			  ...
			  <td><a href="?f=user&m=delete&id=<?php echo $r['iduser']?>"<?php echo $r['iduser']?>">Delete</a></td>
			  <td><a href="?f=user&m=update&id=<?php echo $r['iduser']?>"<?php echo $r['iduser']?>"><?php echo $status ?></a></td>
		  </tr>
		  <?php endforeach ?>
	  </tbody>
